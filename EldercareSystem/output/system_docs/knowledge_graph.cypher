...
MERGE (o:Object {name: 'couch'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'couch'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day1_clip01_9點', time: '09:00:00'}]->(o);
MERGE (o:Object {name: 'cup'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'cup'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day1_clip01_9點', time: '09:00:00'}]->(o);
MERGE (o:Object {name: 'dining table'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'dining table'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day1_clip01_9點', time: '09:00:00'}]->(o);
MERGE (o:Object {name: 'chair'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'chair'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day1_clip01_9點', time: '09:00:00'}]->(o);
...
MERGE (o:Object {name: 'couch'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'couch'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day1_clip02_11點', time: '11:00:00'}]->(o);
...
MERGE (o:Object {name: 'cup'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'cup'})
MERGE (p)-[:INTERACTS_WITH {action: 'Using', clip: 'day1_clip03_13點', time: '13:00:00'}]->(o);
MERGE (o:Object {name: 'dining table'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'dining table'})
MERGE (p)-[:INTERACTS_WITH {action: 'Using', clip: 'day1_clip03_13點', time: '13:00:00'}]->(o);
MERGE (o:Object {name: 'chair'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'chair'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day1_clip03_13點', time: '13:00:00'}]->(o);
MERGE (p:Person {name: '陳爺爺'});
...
MERGE (o:Object {name: 'dining table'});
MATCH (p:Person {name: '陳爺爺'}), (o:Object {name: 'dining table'})
MERGE (p)-[:INTERACTS_WITH {action: 'Touching', clip: 'day1_clip04_15點', time: '15:00:00'}]->(o);
MERGE (o:Object {name: 'chair'});
MATCH (p:Person {name: '陳爺爺'}), (o:Object {name: 'chair'})
MERGE (p)-[:INTERACTS_WITH {action: 'Touching', clip: 'day1_clip04_15點', time: '15:00:00'}]->(o);
MERGE (o:Object {name: 'couch'});
MATCH (p:Person {name: '陳爺爺'}), (o:Object {name: 'couch'})
MERGE (p)-[:INTERACTS_WITH {action: 'Touching', clip: 'day1_clip04_15點', time: '15:00:00'}]->(o);
MERGE (o:Object {name: 'tv'});
MATCH (p:Person {name: '陳爺爺'}), (o:Object {name: 'tv'})
MERGE (p)-[:INTERACTS_WITH {action: 'Touching', clip: 'day1_clip04_15點', time: '15:00:00'}]->(o);
...
MERGE (o:Object {name: 'couch'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'couch'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day2_clip01_9點', time: '09:00:00'}]->(o);
MERGE (o:Object {name: 'remote'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'remote'})
MERGE (p)-[:INTERACTS_WITH {action: 'Holding', clip: 'day2_clip01_9點', time: '09:00:00'}]->(o);
...
MERGE (o:Object {name: 'chair'});
MATCH (p:Person {name: '王奶奶'}), (o:Object {name: 'chair'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day2_clip04_15點', time: '15:00:00'}]->(o);
MERGE (p:Person {name: '陳爺爺'});
...
MERGE (o:Object {name: 'chair'});
MATCH (p:Person {name: '陳爺爺'}), (o:Object {name: 'chair'})
MERGE (p)-[:INTERACTS_WITH {action: 'Sitting_On', clip: 'day2_clip05_17點', time: '17:00:00'}]->(o);
